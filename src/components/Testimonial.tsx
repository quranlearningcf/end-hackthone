...
const Testimonials = () => {
  ...
  const prevSlide = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === 0
        ? Math.max(0, testimonials.length - slidesPerView)
        : prevIndex - 1
    );
  };

  return (
    <section className="mx-auto max-w-[1240px] px-4 py-12 md:py-16 mb-16">
      <div className="flex items-center justify-between mb-8 md:mb-12">
        ...
        <div className="hidden md:flex items-center gap-2">
          <Button
            onClick={prevSlide}
            className="p-2 rounded-full bg-white text-black border border-gray-300 hover:bg-gray-100"
          >
